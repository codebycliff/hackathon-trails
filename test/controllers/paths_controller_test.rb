...
class PathsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create path" do
    assert_difference('Path.count') do
      post paths_url, params: { path: { direction: @path.direction, duration: @path.duration, trail_id: @path.trail_id } }
    end
  ...
  test "should update path" do
    patch path_url(@path), params: { path: { direction: @path.direction, duration: @path.duration, trail_id: @path.trail_id } }
